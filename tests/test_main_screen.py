...
def test_kommentarii_shablonov_ne_popadayut_na_ekran(вошедший, дела):
    """Страж: комментарий {# … #} на несколько строк Django печатает
    как текст (случилось с карточкой дела, 2026-09-06)."""
